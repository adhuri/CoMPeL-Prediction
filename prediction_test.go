...
func TestPredictionEquidistantStates(t *testing.T) {
	...
	acc, err := accuracyChecker(predictedArray, W, 10.0)
	if err != nil {
		t.Error("Accuracy checker failed ", err)
	}
	fmt.Print("Accuracy Percentage - ", acc)
}
